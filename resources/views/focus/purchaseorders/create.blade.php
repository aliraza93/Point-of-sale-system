                            ...
                            <form method="post" id="data_form">
                                ...
                                <div id="saman-row">
                                    <table class="table-responsive tfr my_stripe">
                                        ...
                                        <tr class="sub_c" style="display: table-row;">      <td colspan="2">{{trans('general.payment_currency_client')}}
                                    ...
                                    <div>
                                        <label>{{trans('products.stock_transfer')}}</label>
                                        <fieldset class="right-radio">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label"
                                                       for="customRadioRight1">{{trans('general.yes')}}</label>
                                            </div>
                                        </fieldset>
                                        <fieldset class="right-radio">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label"
                                                       for="customRadioRight2">{{trans('general.no')}}</label>
                                            </div>
                                        </fieldset>
                                ...
                                <input type="hidden" value="purchase" id="billtype">
